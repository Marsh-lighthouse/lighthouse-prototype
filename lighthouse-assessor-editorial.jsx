                              ...
                              <tr key={ind.id} style={{background:outOfRange?`${red}08`:card}}>
                                ...
                                <td style={{position:"sticky",right:0,zIndex:1,background:outOfRange?"#FDF2F2":card,padding:"6px 10px",textAlign:"center",borderLeft:`2px solid ${outOfRange?red:navy}`,borderBottom:`1px solid ${bd}`,width:finalColW,minWidth:finalColW}}>
                                  <div style={{display:"inline-flex",alignItems:"center",gap:8}}>
                                    ...
                                    <button onClick={()=>setNA(ind.id,!isNA)} title={isNA?"Not applicable — score locked":"Editable — click to mark not applicable"} aria-pressed={isNA} style={{display:"inline-flex",alignItems:"center",width:62,height:26,borderRadius:13,background:isNA?teal:"transparent",border:`1.5px solid ${isNA?teal:"#94918C"}`,cursor:"pointer",transition:"all .15s",position:"relative",verticalAlign:"middle"}}>
                                      <span style={{position:"absolute",top:0,bottom:0,display:"flex",alignItems:"center",left:isNA?12:"auto",right:isNA?"auto":12,fontSize:13,fontWeight:700,color:isNA?"#fff":tm}}>N/A</span>
                                      <span style={{position:"absolute",top:2.5,left:isNA?"auto":2.5,right:isNA?2.5:"auto",width:20,height:20,borderRadius:10,background:isNA?"#fff":"#6F6D68",boxShadow:"0 1px 3px rgba(0,0,0,.3)"}}/>
                                    </button>
                                  </div>
