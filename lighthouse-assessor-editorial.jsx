                              ...
                              <tr key={ind.id} style={{background:outOfRange?`${red}08`:card}}>
                                ...
                                <td style={{position:"sticky",right:0,zIndex:1,background:outOfRange?"#FDF2F2":card,padding:"6px 10px",textAlign:"center",borderLeft:`2px solid ${outOfRange?red:navy}`,borderBottom:`1px solid ${bd}`,width:finalColW,minWidth:finalColW}}>
                                  <div style={{display:"inline-flex",alignItems:"center",gap:8}}>
                                    ...
                                    <button onClick={()=>setNA(ind.id,!isNA)} title={isNA?"Not applicable — score locked":"Editable — click to mark not applicable"} aria-pressed={isNA} style={{display:"inline-block",width:70,height:22,borderRadius:11,background:isNA?teal:"transparent",border:`1.5px solid ${isNA?teal:"#94918C"}`,cursor:"pointer",transition:"all .15s",position:"relative"}}>
                                      ...
                                      <span style={{position:"absolute",top:2,left:isNA?"auto":2,right:isNA?2:"auto",width:16,height:16,borderRadius:8,background:isNA?"#fff":"#6F6D68",boxShadow:isNA?"0 1px 2px rgba(0,0,0,.2)":"none"}}/>
                                    </button>
                                  </div>
