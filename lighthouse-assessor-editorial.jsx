...
function AssessorEditorial() {
  ...
  const I = {
    ...
    Report:(p)=><svg width={p?.s||18} height={p?.s||18} viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{__html:`<path d="M 3.75 13.25 L 10.25 13.25 L 10.25 11.75 L 3.75 11.75 L 3.75 13.25 Z M 3.75 9.25 L 13.25 9.25 L 13.25 7.75 L 3.75 7.75 L 3.75 9.25 Z M 3.75 5.25 L 13.25 5.25 L 13.25 3.75 L 3.75 3.75 L 3.75 5.25 Z M 1.808 17 C 1.303 17 0.875 16.825 0.525 16.475 C 0.175 16.125 0 15.697 0 15.192 L 0 1.808 C 0 1.303 0.175 0.875 0.525 0.525 C 0.875 0.175 1.303 0 1.808 0 L 15.192 0 C 15.697 0 16.125 0.175 16.475 0.525 C 16.825 0.875 17 1.303 17 1.808 L 17 15.192 C 17 15.697 16.825 16.125 16.475 16.475 C 16.125 16.825 15.697 17 15.192 17 L 1.808 17 Z M 1.808 15.5 L 15.192 15.5 C 15.269 15.5 15.34 15.468 15.404 15.404 C 15.468 15.34 15.5 15.269 15.5 15.192 L 15.5 1.808 C 15.5 1.731 15.468 1.66 15.404 1.596 C 15.34 1.532 15.269 1.5 15.192 1.5 L 1.808 1.5 C 1.731 1.5 1.66 1.532 1.596 1.596 C 1.532 1.66 1.5 1.731 1.5 1.808 L 1.5 15.192 C 1.5 15.269 1.532 15.34 1.596 15.404 C 1.66 15.468 1.731 15.5 1.808 15.5 Z" fill="currentColor" fill-rule="evenodd" transform="matrix(1 0 0 1 2 2) matrix(1 0 0 1 1.500 1.500)"/>`}}/>,
    Clipboard:(p)=><svg width={p?.s||18} height={p?.s||18} viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{__html:`<path d="M 1.808 19 C 1.309 19 0.883 18.823 0.53 18.47 C 0.177 18.117 0 17.691 0 17.192 L 0 3.808 C 0 3.309 0.177 2.883 0.53 2.53 C 0.883 2.177 1.309 2 1.808 2 L 6.258 2 C 6.321 1.445 6.563 0.973 6.985 0.584 C 7.406 0.195 7.911 0 8.5 0 C 9.095 0 9.603 0.195 10.025 0.584 C 10.447 0.973 10.686 1.445 10.742 2 L 15.192 2 C 15.691 2 16.117 2.177 16.47 2.53 C 16.823 2.883 17 3.309 17 3.808 L 17 17.192 C 17 17.691 16.823 18.117 16.47 18.47 C 16.117 18.823 15.691 19 15.192 19 L 1.808 19 Z M 1.808 17.5 L 15.192 17.5 C 15.269 17.5 15.34 17.468 15.404 17.404 C 15.468 17.34 15.5 17.269 15.5 17.192 L 15.5 3.808 C 15.5 3.731 15.468 3.66 15.404 3.596 C 15.34 3.532 15.269 3.5 15.192 3.5 L 1.808 3.5 C 1.731 3.5 1.66 3.532 1.596 3.596 C 1.532 3.66 1.5 3.731 1.5 3.808 L 1.5 17.192 C 1.5 17.269 1.532 17.34 1.596 17.404 C 1.66 17.468 1.731 17.5 1.808 17.5 Z M 3.75 15.135 L 10.25 15.135 L 10.25 13.635 L 3.75 13.635 L 3.75 15.135 Z M 3.75 11.25 L 13.25 11.25 L 13.25 9.75 L 3.75 9.75 L 3.75 11.25 Z M 3.75 7.365 L 13.25 7.365 L 13.25 5.865 L 3.75 5.865 L 3.75 7.365 Z M 9.038 2.634 C 9.179 2.492 9.25 2.313 9.25 2.096 C 9.25 1.88 9.179 1.7 9.038 1.559 C 8.896 1.417 8.717 1.346 8.5 1.346 C 8.283 1.346 8.104 1.417 7.962 1.559 C 7.821 1.7 7.75 1.88 7.75 2.096 C 7.75 2.313 7.821 2.492 7.962 2.634 C 8.104 2.775 8.283 2.846 8.5 2.846 C 8.717 2.846 8.896 2.775 9.038 2.634 Z" fill="currentColor" fill-rule="evenodd" transform="matrix(1 0 0 1 3.500 1.500)"/>`}}/>,
