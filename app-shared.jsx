...
const LH = {
  ...
  openAssessQuestions: [
    ...
    { id: "oq_mx_textcol", type: "matrix", page: 2, title: "Matrix with comment column", prompt: "Rate each statement, then add a short comment.",
      competency: "Self-Awareness",
      rows: ["I have enough autonomy", "I get timely feedback", "My contribution is recognised"],
      cols: ["Agree", "Disagree", "Don't know"], textCol: "Comment",
      tip: "A matrix table with a trailing free-text column for a per-row note." },
    { id: "oq_mx_stacked", type: "matrix", page: 2, stacked: true, title: "Matrix (stacked)", prompt: "For each statement, choose Agree or Disagree.",
      competency: "Self-Awareness",
      rows: ["I have enough autonomy", "I get timely feedback", "My contribution is recognised"],
      cols: ["Agree", "Disagree"],
      tip: "The matrix table shown in its stacked layout — one statement per card." },
    ...
    { id: "oq_numgrid_scale", type: "numgrid", page: 2, noNa: true, title: "Numeric grid (scale points)", prompt: "Enter a value for each choice across the scale points.",
      competency: "Prioritisation",
      rows: ["Choice 1", "Choice 2", "Choice 3"],
      cols: ["Scale point 1", "Scale point 2", "Scale point 3"],
      tip: "A numeric grid with a running row Total." },
    { id: "oq_numgrid_select", type: "numgrid", page: 2, noNa: true, cellSelect: true, selectOptions: [0, 1, 2, 3, 4, 5], title: "Numeric grid (dropdown)", prompt: "Pick a value for each choice across the scale points.",
      competency: "Prioritisation",
      rows: ["Choice 1", "Choice 2", "Choice 3"],
      cols: ["Scale point 1", "Scale point 2", "Scale point 3"],
      tip: "The numeric grid with dropdown cells instead of typed numbers." },
